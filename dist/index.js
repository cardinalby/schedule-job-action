...
const {configurationErrorTask} = __webpack_require__(614);
...
function runImpl() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const targetRef = actionInputs_1.actionInputs.addTag !== undefined
            ? actionInputs_1.actionInputs.addTag
        ...
        ghActions.info(`Copying ${actionInputs_1.actionInputs.templateYmlFile} to ${targetYmlFileAbsPath}...`);
        const copyFlags = actionInputs_1.actionInputs.overrideTargetFile
            ? undefined
        ...
        if (actionInputs_1.actionInputs.addTag !== undefined) {
            ghActions.info(`Git: add ${actionInputs_1.actionInputs.addTag} tag...`);
            yield git.addTag(actionInputs_1.actionInputs.addTag);
        }
...
function getWorkspaceGit() {
    return __awaiter(this, void 0, void 0, function* () {
        const git = simple_git_1.default(github_actions_utils_1.getWorkspacePath());
        yield git.addConfig('user.email', actionInputs_1.actionInputs.gitUserEmail);
        yield git.addConfig('user.name', actionInputs_1.actionInputs.gitUserName);
        return git;
    });
}
function getTargetYmlFileName(targetRef) {
    if (actionInputs_1.actionInputs.targetYmlFileName !== undefined) {
        return actionInputs_1.actionInputs.targetYmlFileName;
    }
    const templateYmlFilePath = path.parse(actionInputs_1.actionInputs.templateYmlFile);
    if (templateYmlFilePath.ext !== '.yml') {
        ghActions.warning(`${actionInputs_1.actionInputs.templateYmlFile} file has not a .yml extension`);
    }
...
exports.actionOutputs = {
    targetYmlFileName: new github_actions_utils_1.ActionOutput('targetYmlFile'),
    targetYmlFilePath: new github_actions_utils_1.ActionOutput('targetYmlFilePath')
};
